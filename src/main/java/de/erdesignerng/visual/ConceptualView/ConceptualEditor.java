...
public class ConceptualEditor implements GenericModelEditor {
    ...
    public ConceptualEditor() {
        ...
        editorPanel = new EditorPanel() {
            ...
            public void componentClicked(EditorComponent aComponent, MouseEvent aEvent) {
                ConceptualEditor.this.componentClicked(aComponent, aEvent);
            }
            ...
            protected JComponent getHighlightComponentFor(EditorComponent aComponent) {
                ...
                if (theItem instanceof Table) {
                    return new ConceptualTableComponent((Table) theItem, true);
                }
    ...
    @Override
    public void commandAddToNewSubjectArea(java.util.List<ModelItem> aItems) {
    }

    @Override
    public void commandDelete(java.util.List<ModelItem> aItems) {
    }
    ...
    private void generateGraphFor(Table aTable) {
        ...
        ConceptualTableComponent theButton = new ConceptualTableComponent(aTable);
        ...
        java.util.List<Table> theAlreadyKnown = new ArrayList<>();
        theAlreadyKnown.add(aTable);

        // Level 1
        java.util.List<Relation> theIncomingRelationsLevel1 = new ArrayList<>();
        ...
        if (theTablesLevel1.size() > 0) {
            ...
            for (Table theTableLevel1 : theTablesLevel1) {
                ...
                ConceptualTableComponent theButtonLevel1 = new ConceptualTableComponent(theTableLevel1);
